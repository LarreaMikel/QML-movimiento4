...
UBUNTU_TRANSLATION_DOMAIN="qml-movimiento4.larreamikel"
...
aptest.commands = bash $$PWD/QML-movimiento4/tests/autopilot/run
aptest.depends  = sub-QML-movimiento4

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/QML-movimiento4/tests/unit
unittest.depends  = sub-QML-movimiento4
